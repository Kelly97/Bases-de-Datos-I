...
CREATE SEQUENCE tbl_flips_codigo_flip_seq START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER tbl_flips_codigo_flip_trg BEFORE
    INSERT ON tbl_flips
    FOR EACH ROW
    WHEN (
...
BEGIN
    :new.codigo_flip := tbl_flips_codigo_flip_seq.nextval;
END;
/
