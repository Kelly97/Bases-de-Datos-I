...
switch ($_POST["codigo"]) {
	case 0:
		?>
		  <div class="col-lg-12" style="text-align: center;padding-bottom: 40px; width: 100%;">
		...
		<div class="card-columns">
			...
			<div class="card noti-card" style="position: relative;">
			  ...
			  <div class="card-body" style="text-align: justify;">
			    <h4 class="card-title">Titulo Noticia</h4>
			    <span class="noti-card-autor">Autor o propietario de noticia</span>
			    <p class="card-text">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la a la imprenta) desconocido usó en. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicostware de au a la imprenta) desconocido usó en. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicostware de au imprenta) desconocido usó en. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicostware de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.</p>
			    <p>
		        	5 
		        	<i class="fa fa-heart" aria-hidden="true" style="font-size: 13px;padding-right: 8px;color: red;">
			        </i>
			...
			<div class="card noti-card" style="position: relative;">
			  ...
			  <div class="card-body" style="text-align: justify;">
			    <h4 class="card-title">Titulo Noticia</h4>
			    <span class="noti-card-autor">Autor o propietario de noticia</span>
			    <p class="card-text">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó en. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicostware de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.</p>
			    <p>
		        	5 
		        	<i class="fa fa-heart" aria-hidden="true" style="font-size: 13px;padding-right: 8px;color: red;">
			        </i>
		    ...
		    <!--<div class="thumbnail" style="position: relative;">		    
		      ...
		      <a href="noticia.html">
			      <img src="images/noticias/img_prueba.jpg" alt="...">
			      <div class="caption">
		   ...
		   <div class="">
		    <div class="thumbnail" style="position: relative;">		    
		      ...
		      <a href="noticia.html">
			      <img src="images/noticias/img_prueba_2.jpeg" alt="...">
			      <div class="caption">
			        <h3>Titulo Noticia</h3>
			        <h5>Autor o propietario de noticia</h5>
			        <p style="text-align: justify;">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó en. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicostware de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.</p>
		   ...
		   <div class="">
		    <div class="thumbnail" style="position: relative;">		    
		      ...
		      <a href="noticia.html">
			      <img src="images/noticias/img_prueba_3.jpg" alt="...">
			      <div class="caption">
			        <h3>Titulo Noticia</h3>
			        <h5>Autor o propietario de noticia</h5>
			        <p style="text-align: justify;">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó en. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicostware de autoedición, sde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó en. No sólo sobrevivió 500 años, sino que tambien ingresó como texto sde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó en. No sólo sobrevivió 500 años, sino que tambien ingresó como texto como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.</p>
			        <p>
			        	5 
			        	<i class="fa fa-heart" aria-hidden="true" style="font-size: 13px;padding-right: 8px;color: red;">
				        </i>
		    ...
		    <div class="thumbnail" style="position: relative;">		    
		      ...
		      <a href="noticia.html">
			      ...
			      <div class="caption">
			        <h3>Titulo Noticia</h3>
			        <h5>Autor o propietario de noticia</h5>
			        <p style="text-align: justify;">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde elno en documentos electrónicostware de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.</p>
			        <p>
			        	5 
			        	<i class="fa fa-heart" aria-hidden="true" style="font-size: 13px;padding-right: 8px;color: red;">
				        </i>
		    ...
		    <div class="thumbnail" style="position: relative;">		    
		      ...
		      <a href="noticia.html">
			      ...
			      <div class="caption">
			        <h3>Titulo Noticia</h3>
			        <h5>Autor o propietario de noticia</h5>
			        <p style="text-align: justify;">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedi</p>
			        <p>
			        	5 
			        	<i class="fa fa-heart" aria-hidden="true" style="font-size: 13px;padding-right: 8px;color: red;">
				        </i>
